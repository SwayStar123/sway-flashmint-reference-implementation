...
// A contract with a function that can only be called if some value was forwarded
// The contract then forces the forwarded amount back to the sender, optionally underpaying by 1
